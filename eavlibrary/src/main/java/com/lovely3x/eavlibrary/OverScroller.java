...
public class OverScroller {
     ...
     * @param interpolator The scroll interpolator. If null, a default (viscous) interpolator will
     *                     be used.
     * @param flywheel     If true, successive flingInner motions will keep on increasing scroll speed.
     * @hide
     */
    ...
    /**
     * Returns where the scroll will end. Valid only for "flingInner" scrolls.
     *
    ...
    /**
     * Start scrolling based on a flingInner gesture. The distance traveled will
     * depend on the initial velocity of the flingInner.
     *
     * @param startX    Starting point of the scroll (X)
     * @param startY    Starting point of the scroll (Y)
     * @param velocityX Initial velocity of the flingInner (X) measured in pixels per
     *                  second.
     * @param velocityY Initial velocity of the flingInner (Y) measured in pixels per
     *                  second
    ...
    public void fling(int startX, int startY, int velocityX, int velocityY,
        ...
        // Continue a scroll or flingInner in progress
     ...
     * flingInner functions. However there are cases where this cannot be known
    ...
    static class SplineOverScroller {
        ...
        void finish() {
            ...
            // Not reset since WebView relies on this value for fast flingInner.
            // TODO: restore when WebView uses the fast flingInner implemented in this class.
            // mCurrVelocity = 0.0f;
            mFinished = true;
        }
        ...
        void notifyEdgeReached(int start, int end, int over) {
            ...
            if (mState == SPLINE) {
                mOver = over;
                mStartTime = AnimationUtils.currentAnimationTimeMillis();
                // We were in flingInner/scroll mode before: current velocity is such that distance to
                // edge is increasing. This ensures that startAfterEdge will not start a new flingInner.
